%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Peking Univ. Physical Review (en)
%
% LaTeX Template
% Version 2.1
% Release 03/19/18
...
\documentclass[10pt,a4paper,twocolumn]{PPRAen} % Document font size
...
\input{essay/info} %Insert the title, authors, abstract (and keywords).
